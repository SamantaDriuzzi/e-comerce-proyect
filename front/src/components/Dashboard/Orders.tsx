...
function Orders() {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="bg-blue shadow-md rounded-lg p-4 flex mb-4 flex-wrap flex-row justify-center gap-8">
        {orders?.length! > 0 ? (
          orders?.map((order) => (
            <div
              key={order.id}
              className="bg-white shadow-md rounded-lg p-6 justify-center hover:shadow-2xl hover:bg-orangeBase"
            >
